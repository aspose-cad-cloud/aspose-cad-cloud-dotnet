...
{
	/// <summary>
	/// Wrapper class for Aspose.CAD Cloud Tools context access to Pages and controls
	/// </summary>
	public class AsposeCADCloudContext : Context
	{
		/// <summary>
		...
		/// </summary>
		/// <param name="hc"></param>
		internal AsposeCADCloudContext(HttpContext hc) : base(hc) { Thread.SetData(Thread.GetNamedDataSlot(Configuration.ResourceFileSessionName + "ContextSlot"), hc); }
		private static AsposeCADCloudContext atc;
		/// <summary>
		///  Use for internal syncing of the context
		/// </summary>
		internal static AsposeCADCloudContext atcc { set { atc = value; } }
		internal static AsposeCADCloudContext Current
		{
			get { return atc; }
		}
