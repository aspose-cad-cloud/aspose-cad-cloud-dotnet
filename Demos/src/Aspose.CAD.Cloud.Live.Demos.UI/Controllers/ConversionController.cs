using Aspose.CAD.Cloud.Live.Demos.UI.Models.Common;
				...
				if (postedFile != null)
				{
					...
					if ((isFileUploaded != null) && (isFileUploaded.FileName.Trim() != ""))
					{
						AsposeCADConversion asposeCADConversion = new AsposeCADConversion();
							 response = asposeCADConversion.Convert(isFileUploaded.FileName, isFileUploaded.FolderId,   outputType.ToLower().Replace(" ", ""));
